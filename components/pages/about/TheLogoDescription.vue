<template>
  <div class="about">
    <div class="message-container">
      ...
      <div class="message-message">
        ...
        <p class="text web-message">
          ４本線は、弊社の価値観『圧倒的当事者意識』『目の前の人を大事に』『和衷協同』に加えて、各メンバーが持つ個人の価値観を指しています。同じ価値観は共有しながらも個性を活かします。
        </p>
        <br>
        <p class="main-message sub-title">
          "掛け算"の価値を提供する
        ...
        <p class="text web-message">
          我々コンサルティングエンジニア集団のことを『x-faCE（for all Consulting Engineer、呼名：クロスフェイス）』と名乗っています。お客様に対して後ろから支える存在となる、そして足し算ではなく掛け算で価値を提供するように『クロス（x）』をモチーフにしています。
        </p>
      </div>
    </div>
    <div class="logo-message">
      ...
      <div class="logo-explanation">
        <div class="text logo-explanation-body">
          実はこのロゴは単体では完結しません。一人の力では限界があるため、複数のロゴが集まることで一つの形を作れるようになっています。『チーム』で提供する価値を大事にしています。
        </div>
      </div>
    </div>
    <div class="logo-pattern">
      <div class="make-logo">
        <img :src="xface_multi02">
      </div>
      <p class="image-message">
        100人（100個のロゴ）が集まると、格子のように<br>
        より大きい期待に答えられることができます
      </p>
    </div>
    <div class="logo-pattern">
      <div class="make-logo">
        <img :src="xface_multi03">
      </div>
      <p class="image-message">
    ...
    <div class="logo-pattern">
      <div class="make-logo">
        <img :src="xface_multi04">
      </div>
      <p class="image-message">
        全員が自走しながら動き回ることで、独創性のある形を表現することもでき<br>
        ます。この組織ではゼロからイチを生み出すことができそうです。
      </p>
    </div>
  </div>
</template>
