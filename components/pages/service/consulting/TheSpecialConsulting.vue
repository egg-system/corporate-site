  ...
  <div>
    ...
    <div class="columns reverse">
      ...
      <div class="column is-half">
        ...
        <div class="message">まずは<nuxt-link to="/contact">お問い合わせフォーム</nuxt-link>よりお気軽にご相談ください。</div>
      </div>
    </div>
    <div>
    ...
    <div class="columns">
      ...
      <div class="column is-half">
        ...
        <div class="message">
          サロン開業メディア「EGG」では、主にサロンオーナー様へのインタビュー記事を掲載し、
          店舗運営において上手くいったことや上手くいかなかったことをリアルにお伝えしています。
        </div>
        <div class="link">
