<template>
  <section class="service-detail-section">
    <h3>売上拡大・業務効率化を実現するためにシステム企画から運用まで対応</h3>
    <div class="columns">
      ...
      <div class="service-detail column first is-7">
        <div>
          <p>
            「整体・エステ・パーソナルトレーニングジムなど実店舗での売上を上げたい」<br>
            「ECサイトでの販売を始めたい」<br>
            「Amazon・楽天・Yahooなどオンラインの売り場を増やしたいが、サイト毎に管理する手間が増えるため躊躇している」<br>
            「働き方改革として従業員満足度を上げたい」<br>
            「社員を採用したい」
          </p>
          <p>
        ...
        <div>
          <ul>
            ...
            <li>売上を拡大したい店舗ビジネスのオーナー</li>
            <li>売上が下がっている</li>
            <li>社員一人ひとりの生産性を上げたい</li>
            <li>紙や手作業を使った業務が多い</li>
            <li>採用ができない</li>
          </ul>
        </div>
...
<script>
import consultingImage from '~/assets/service/img/consult-image.JPG'
