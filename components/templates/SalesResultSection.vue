    ...
    recMessage: function() {
      if (this.industryVal != 'NO DATA') {
        return this.clientVal - this.industryVal < 0
          ? '同業他社よりシステムにかかる費用が少ないため、<br>システム導入による利便性向上・業務効率化などへ取り組む余地があります'
          : '同業他社よりシステムにかかる費用が多いため、<br>コスト削減への取り組みをオススメいたします'
      } else {
        return 'こちらからお問い合わせいただければ、<br>シミュレーションの試算が可能です。'
      }
    },
    // 業種を取得
    industry: function() {
