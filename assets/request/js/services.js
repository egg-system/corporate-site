...
const services = [
  {
    ...
    description:
      '-新システム導入や既存システムのリプレイスをご検討されている企業様向け<br>-目安期間：約2～3ヶ月程度<br>-参考価格：約100万円～500万円',
    img: serviceImage1
  },
  {
    title: 'システム化支援/業務改善<br>コンサルティングサービス',
    description:
      '-既存システムのコスト削減や業務運用の効率化を図りたい企業様<br>-目安期間：約3ヶ月～1年程度<br>-参考価格：約50万円～160万円/月',
    img: serviceImage2
  },
  {
    title: 'プロジェクトマネジメントサービス',
    description:
      '-新システム導入が決まっている、既にプロジェクトが進行中の企業様向け<br>-目安期間：約6ヶ月～1年<br>-参考価格：約100万円～180万円/月',
    img: serviceImage3
  },
  {
    title: '業界特化型<br>サービス',
    description:
      '-サロン・整体・エステ・接骨院・マッサージ・トレーニングジムの事業で集客に課題を抱えたオーナー様向け<br>-目安期間：約半年～1年<br>-参考価格：約5万円～10万円/月',
    img: serviceImage4
  },
  {
    title: 'システム開発',
    description:
      '-システム導入や改修をご検討されている企業様<br>-準委任・請負いずれも対応可能<br>-費用は都度お見積り',
    img: serviceImage5
  }
]
