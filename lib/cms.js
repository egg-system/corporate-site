...
export async function fetchCmsListDataCaseByCategoryId(categoryId, limit = 10) {
  return await fetchCmsListDataByCategoryId(CASE_PAGE, categoryId, limit)
}
