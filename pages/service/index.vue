      ...
      meta: [
        {
          ...
          name: 'description',
          content:
            '中小企業が抱える「経験豊富な人材の不足」「システムを有効活用できない」という課題を解決するコンサルティングからシステム開発まで一貫して行うコンサルティングエンジニア集団です。月額定額のコンサルティングエンジニアサービス、IT戦略/IT投資計画策定サービス 、IT統制サポート、RPA導入サービス、システム開発を行っています。'
        },
        {
